package vn.edu.ntu.vancuong.phamvancuong_59130221_simplewidget;
...
public class MainActivity extends AppCompatActivity {
    ...
    EditText editName, editBrith, editSoThich;
    ...
    public void addView(){
        ...
        editBrith = findViewById(R.id.editBrith);
    ...
    void addAction(){
        btnClick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                txtText += "\nNgày Sinh" + editBrith.getText().toString();
            ...
            txtText += "\n Sở thích :";
                ...
                txtText += editSoThich.getText().toString();
